...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/loryman/dotfiles-linux" && repobranch="master"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/loryman/dotfiles-linux/master/progs.csv"
...
putgitrepo "$dotfilesrepo" "$repobranch"
